...
public class TileMap {
	...
	// position
	public int x,y,xdest,ydest,speed;
	...
	// map
	public int[][] map;
	public int tileSize,numRows,numCols,width,height;
	...
	/**
	 * This contsructs a map of tile with a specified tile size
	...
	/**
	 * Load tiles of game inside frame
	 * @param string s
	 */
